...
// const HR_MENU = [
//     {
//         path: '/hr', label: 'HR Overview', exact: true,
...
//                 : 'text-amber-100 hover:bg-amber-500/60 hover:text-white'
//             }
//     `}
//     >
//         {({ isActive }) => (
//             <>
//                 <span className={`flex-shrink-0 transition-colors ${isActive ? 'text-amber-600' : 'text-amber-200 group-hover:text-white'}`}>
//                     {icon}
//                 </span>
...
//             <p className="text-amber-300/70 text-xs font-bold uppercase tracking-widest whitespace-nowrap">
//                 {label}
//             </p>
//             <div className="flex-1 h-px bg-amber-500/40" />
//         </div>
...
//       `}>
//                 {/* Logo */}
//                 <div className="flex items-center justify-between px-5 py-5 border-b border-amber-400/50">
...
//                             <p className="text-amber-100 text-xs mt-0.5">HR Panel</p>
//                         </div>
//                     </div>
//                     <button onClick={onClose} className="lg:hidden text-amber-100 hover:text-white">
...
//                     <p className="text-amber-100/70 text-xs font-bold uppercase tracking-widest px-4 mb-2">Main Menu</p>
//                     {MAIN_MENU.map(item => (
...
//                 {/* User Card + Logout */}
//                 <div className="px-3 py-4 border-t border-amber-400/50">
//                     <div className="flex items-center gap-3 px-3 py-3 bg-amber-400/30 rounded-xl mb-3">
//                         <div
...
//                             <p className="text-xs truncate" style={{ color: '#fff' }}>
//                                 {roleInfo.label}
//                             </p>
//                         </div>
//                     </div>
...
//                         className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-amber-100 hover:bg-red-500/80 hover:text-white transition-all duration-200 group"
//                     >
//                         <svg className="w-5 h-5 text-amber-100 group-hover:text-white flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      `}>
                ...
                <div className="flex items-center justify-between px-5 py-5 border-b border-blue-500/50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-white text-lg font-extrabold leading-none">Callyzer</h1>
                            <p className="text-blue-200 text-xs mt-0.5">HR Panel</p>
                        </div>
                    </div>
