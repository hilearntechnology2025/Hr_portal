...
//       `}>
//                 {/* Logo */}
//                 <div className="flex items-center justify-between px-5 py-5 border-b border-blue-600/50">
...
//                     <div className="flex items-center gap-3 px-3 py-3 bg-blue-600/30 rounded-xl mb-3">
//                         <div
