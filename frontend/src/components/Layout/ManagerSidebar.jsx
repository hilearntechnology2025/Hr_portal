...
//     },
//     {
//         path: '/manager', label: 'Manager Overview', exact: true,
...
//         {({ isActive }) => (
//             <>
//                 <span className={`flex-shrink-0 transition-colors ${isActive ? 'text-indigo-600' : 'text-indigo-200 group-hover:text-white'}`}>
//                     {icon}
//                 </span>
...
//             <p className="text-indigo-300/70 text-xs font-bold uppercase tracking-widest whitespace-nowrap">
//                 {label}
//             </p>
//             <div className="flex-1 h-px bg-indigo-500/40" />
//         </div>
...
//       `}>
//                 {/* Logo */}
//                 <div className="flex items-center justify-between px-5 py-5 border-b border-indigo-500/50">
...
//                             <p className="text-indigo-200 text-xs mt-0.5">Manager Panel</p>
//                         </div>
//                     </div>
...
//                     <p className="text-indigo-300/70 text-xs font-bold uppercase tracking-widest px-4 mb-2">Main Menu</p>
...
//                 {/* User Card + Logout */}
//                 <div className="px-3 py-4 border-t border-indigo-500/50">
//                     <div className="flex items-center gap-3 px-3 py-3 bg-indigo-500/30 rounded-xl mb-3">
//                         <div
...
//                         className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-indigo-100 hover:bg-red-500/80 hover:text-white transition-all duration-200 group"
//                     >
//                         <svg className="w-5 h-5 text-indigo-200 group-hover:text-white flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
