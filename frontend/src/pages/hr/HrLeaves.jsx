...
//                             <span className={`text-xs px-2 py-0.5 rounded-full font-medium ${LEAVE_TYPE_COLORS[leave.leaveType]}`}>
//                                 {leave.leaveType}
//                             </span>
//                         </div>
//                         <div className="flex justify-between">
...
//             const res = await fetch(`${API}/hr/leaves?${params}`, { headers });
//             const data = await res.json();
...
//                                     {['Employee', 'Type', 'Duration', 'Dates', 'Reason', 'Status', 'Action'].map(h => (
...
//                                                     <p className="text-xs text-gray-400">{leave.employee?.role}</p>
//                                                 </div>
//                                             </div>
//                                         </td>
//                                         <td className="px-5 py-4">
//                                             <span className={`text-xs px-2.5 py-1 rounded-full font-medium ${LEAVE_TYPE_COLORS[leave.leaveType]}`}>
//                                                 {leave.leaveType}
//                                             </span>
//                                         </td>
...
//                                                     {leave.remarks ? `"${leave.remarks.slice(0, 20)}..."` : 'Done'}
//                                                 </span>
//                                             )}
//                                         </td>
//                                     </tr>
